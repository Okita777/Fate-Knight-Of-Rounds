...
{
    [System.Serializable]
    public class GraphEvent_Math_Add_Float : BluePrint_Float
    {
        ...
        #region Property
        [EditorGraphProperty("加数", true, EditorGraphPropertyType.EEPT_Float)]
...
#if UNITY_EDITOR
        //保存时避免重复实例化，导致引用地址变更
        [System.NonSerialized] protected GraphEvent_Math_Add_Float _graphEvent = null;
#endif
        public override BluePrint_Value Clone()
        {
            ...
            {
                _graphEvent = new GraphEvent_Math_Add_Float();
