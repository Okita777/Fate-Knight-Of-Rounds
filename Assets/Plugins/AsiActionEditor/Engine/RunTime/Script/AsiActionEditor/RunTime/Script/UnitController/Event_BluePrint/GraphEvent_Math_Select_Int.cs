...
{
    [System.Serializable]
    public class GraphEvent_Math_Select_Int : BluePrint_Int
    {
        ...
        #region Property
        [EditorGraphProperty("True", true, EditorGraphPropertyType.EEPT_Int)]
        ...
        [EditorGraphProperty("False", true, EditorGraphPropertyType.EEPT_Int)]
...
#if UNITY_EDITOR
        //保存时避免重复实例化，导致引用地址变更
        [System.NonSerialized] protected GraphEvent_Math_Select_Int _graphEvent = null;
#endif
        public override BluePrint_Value Clone()
        {
            ...
            {
                _graphEvent = new GraphEvent_Math_Select_Int();
