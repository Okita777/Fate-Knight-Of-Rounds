...
namespace AsiActionEngine.Editor
{
    ...
    {
        private void DrawGValueEquationGUI(EditorGValueEquation _gValue)
        {
            using (new GUILayout.HorizontalScope())
            {
                ...
                {
                    _gValue.m_SorID = EditorGUILayout.DelayedIntField(_gValue.m_SorID);
                    if (_check.changed)
                    {
            ...
            using (new GUILayout.HorizontalScope())
            {
                ...
                using (var _check = new EditorGUI.ChangeCheckScope())
                {
                    _gValue.m_Name = EditorGUILayout.DelayedTextField(_gValue.m_Name);
                    if (_check.changed)
                    {
            ...
            {
                GUILayout.Label("真实序号：" + _gValue.m_RealID);
            }
