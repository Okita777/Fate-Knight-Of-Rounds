...
namespace AsiActionEngine.Editor
{
    ...
    public class EditorIcons : EditorWindow
    {
        ...
        private static EditorIcons mWindow;
        public static void EditorIconsOpen()
        {
            if (mWindow is null)
            {
                mWindow = CreateWindow<EditorIcons>("Editor Icons");
                mWindow.ShowUtility();
                mWindow.minSize = new Vector2(320, 450);
            }
            else
            {
                mWindow.Close();
        ...
        GUIContent GetIcon(string icon_name)
        {
            ...
            return valid?.image is null ? null : valid;
        }
